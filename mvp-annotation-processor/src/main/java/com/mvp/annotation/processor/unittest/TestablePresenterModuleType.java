 ...
 */
public class TestablePresenterModuleType extends AbsGeneratingType {
    ...
    public TestablePresenterModuleType(Filer filer, Elements elementUtils, String packageName, Gang gang) {
